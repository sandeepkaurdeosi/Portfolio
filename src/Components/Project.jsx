...
const projects = [
  ...
  {title: "Pokémon Card Collection",
    description: "A fun side project where you can browse and view detailed information on various Pokémon using the PokeAPI. You can also search for Pokémon by name for quick access to specific ones.",
    technologies: "React.js, Tailwind CSS, PokeAPI",
    features: [
      "Displays individual Pokémon cards with dynamic data.",
      "Responsive design to work across devices.",
      "Search functionality to find Pokémon by name.",
      "Uses PokeAPI to fetch real-time Pokémon data."
    ],
    image: "https://img.pokemondb.net/artwork/large/pikachu.jpg",  // Pokémon image or custom image
    liveDemo: "#",
    sourceCode: "#",
  },
];
